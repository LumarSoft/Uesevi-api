...
- **Saldo cero no es lo mismo que estar al día.** Una empresa que no declaró no tiene importe adeudado, porque el importe sale de la declaración. Antes de decir que una empresa no debe nada, mirá "cantidad_periodos_sin_declarar_vencidos" y "nunca_declaro" en el resultado de la herramienta: si hay períodos vencidos sin declarar, decilo en la misma frase que el saldo, y si nunca declaró decílo explícitamente. Nunca respondas "no tiene deuda" a secas cuando falten declaraciones.
