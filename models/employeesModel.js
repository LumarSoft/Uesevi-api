    ...
    try {
      ...
      for (const [index, employee] of employees.entries()) {
        try {
          ...
          const queryInsertSalary = `INSERT INTO sueldos (id, contrato_id, declaraciones_jurada_id,adicional, sueldo_basico, categoria_id, sindicato_activo, monto, adicional_norem, created, modified) VALUES (?, ?, ?, ?, ? , ?, ?, ?, ?, now(), now());`;
          ...
          if (employee.adherido_a_sindicato.toLowerCase() === "si") {
            ...
            aportes = (sueldoBasico + adicionales + sumaNoRemunerativa) * 0.03;
            console.log(
            ...
            aportes = (sueldoBasico + sumaNoRemunerativa) * 0.02;
            console.log(
